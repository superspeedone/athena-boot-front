        ...
        <Row>
            <Col>
                <Card>
                    ...
                    <Row>
                        <Table :loading="loading" border :columns="columns" :data="data" size="small" sortable="custom" @on-sort-change="changeSort" @on-selection-change="showSelect" ref="table"></Table>
                        <Table :columns="columns" :data="exportData" size="small" ref="exportTable" style="display:none"></Table>
                    </Row>
