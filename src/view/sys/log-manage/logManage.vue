        ...
        <Row>
            <Col>
                <Card>     
                    ...
                    <Row>
                        <Table :loading="loading" border :columns="columns" :data="data" ref="table" size="small" sortable="custom" @on-sort-change="changeSort" @on-selection-change="changeSelect"></Table>
                    </Row>
